...
static const char *const yytname[] =
{
  ...
  "DIV", "NL", "NUMBER", "$accept", "input", "line", "expr", YY_NULLPTR
};
...
#line 31 "ast.y"
                {
    int len = strlen((yyvsp[-2].sval)) + 4 + strlen((yyvsp[0].sval));
    char *s = malloc(len);
    sprintf(s, "%s %s +", (yyvsp[-2].sval), (yyvsp[0].sval));
    (yyval.sval) = s;
}
#line 1088 "ast.tab.c"
    break;
